...
class EPOS4Registers:
    ...
    GEAR_REDUCTION_NUMERATOR = EPOS4Obj(0x3003, 1, 'I', 32)
    ...
    POSITION_CONTROLLER_P_GAIN = EPOS4Obj(0x30A1, 0x1, 'I', 32)
    POSITION_CONTROLLER_I_GAIN = EPOS4Obj(0x30A1, 0x2, 'I', 32)   #6.2.59
    POSITION_CONTROLLER_D_GAIN = EPOS4Obj(0x30A1, 0x3, 'I', 32)
    POSITION_CONTROLLER_FF_VELOCITY_GAIN = EPOS4Obj(0x30A1, 0x4, 'I', 32)
    POSITION_CONTROLLER_FF_ACCELERATION_GAIN = EPOS4Obj(0x30A1, 0x5, 'I', 32)

    VELOCITY_CONTROLLER_P_GAIN = EPOS4Obj(0x30A2, 0x1, 'I', 32)   #6.2.60
    VELOCITY_CONTROLLER_I_GAIN = EPOS4Obj(0x30A2, 0x2, 'I', 32)
    VELOCITY_CONTROLLER_FF_VELOCITY_GAIN = EPOS4Obj(0x30A2, 0x3, 'I', 32)
    VELOCITY_CONTROLLER_FF_ACCELERATION_GAIN = EPOS4Obj(0x30A2, 0x4, 'I', 32)
